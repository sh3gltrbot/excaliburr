...
exports.run = (client, message, args) => {
  ...
  .addField(':warning: Uyarı ;', '`unban` adlı komutu özel mesajlarda kullanamazsın.')
  ...
  let user = args[0];
  let modlog = guild.channels.find('name', 'dw-log');
  if (!modlog) return message.reply('`dw-log` kanalını bulamıyorum.');
